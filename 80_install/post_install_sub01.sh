...
pushd /tmp
find www/ttrss/ -name "*.css" -type f -print0 | xargs -0i -P 20 -n 1 bash ${CURRENT_DIR}/80_install/post_install_sub01_01.sh {}
find www/ttrss/ -name "*.js" -type f -print0 | xargs -0i -P 20 -n 1 bash ${CURRENT_DIR}/80_install/post_install_sub01_01.sh {}
popd
