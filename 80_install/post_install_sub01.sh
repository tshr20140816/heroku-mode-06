...
pushd /tmp
find www/ttrss/ -name "*.css" -type f -print0 | xargs -0i -P 20 -n 2 bash /tmp/post_install_sub01_01.sh {}
find www/ttrss/ -name "*.js" -type f -print0 | xargs -0i -P 20 -n 2 bash /tmp/post_install_sub01_01.sh {}
popd
