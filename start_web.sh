...
if [ ${MODE} = 'APACHE' ]; then
  ...
  tmp1=$(curl https://github.com/apache/httpd/releases | grep -o -E '/apache/httpd/releases/tag/2\.4\..+?"')
  echo $tmp1
  tmp2=$(curl https://github.com/apache/httpd/releases | grep -o -E '/apache/httpd/releases/tag/2\.4\..+?"' | head -n 1)
  echo $tmp2
  apache_lastest_version=$(curl https://github.com/apache/httpd/releases | grep -o -E '/apache/httpd/releases/tag/2\.4\..+?"' | head -n 1 | grep -o -E '2.+\d')
