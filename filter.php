...
__HEREDOC__;
  ...
  if ($range !== null && $range_last_number == 0) {
    $body = preg_replace('/<!-- generated by DeleGate\/x.x.x -->.+/s', '<A HREF=https://"' . $_SERVER['HTTP_X_HOST_NAME']
                         . '/ml/' . ($range_start_number - 100) . '-'
                         . $range_start_number . '">PRE100</A></BODY></HTML>', $body);
  } else {
